...
export function IconUser({ className, ...props }: ComponentProps<'svg'>) {
  return (
    <svg
...
export function IconArrowElbow({ className, ...props }: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
...
export function IconRobot({ className, ...props }: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
